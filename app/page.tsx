...
export default async function Home() {
  ...
  return (
    <main className="relative isolate flex min-h-full flex-1 items-center overflow-hidden">
      ...
      <section className="mx-auto grid w-full max-w-5xl items-center gap-10 px-4 py-14 sm:py-20 lg:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="rounded-2xl border border-zinc-300/70 bg-white/80 p-5 shadow-sm backdrop-blur sm:p-6 dark:border-zinc-700 dark:bg-zinc-900/70">
          <div className="space-y-4">
